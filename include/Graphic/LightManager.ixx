...
class LightManager {
 private:
  ...
  std::vector<std::shared_ptr<VulkanEngine::LoggerGPU>> _loggerGPUDirectional;
  std::vector<std::vector<std::shared_ptr<VulkanEngine::LoggerGPU>>> _loggerGPUPoint;
  // for 2 frames
 ...
 public:
  ...
  const std::vector<std::vector<std::shared_ptr<VulkanEngine::LoggerGPU>>>& getPointLightLoggers();
  ...
  const std::vector<std::shared_ptr<VulkanEngine::LoggerGPU>>& getDirectionalLightLoggers();
