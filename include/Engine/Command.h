...
class CommandBuffer {
 ...
 public:
  ...
  void endCommands(int cmd, int queueIndex = 0, bool blocking = true, std::shared_ptr<Fence> fence = nullptr);
  void endCommands(int cmd, int queueIndex, VkSubmitInfo info, std::shared_ptr<Fence> fence);
