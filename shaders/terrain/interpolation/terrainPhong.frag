...
void main() {
    ...
    if (fract(fragTexCoord.x) < push.stripeLeft && fract(fragTexCoord.y) < push.stripeTop) {
        ...
        //      |
        //      |
        outColor = getColorCorner(texSampler, ivec2(0, 1), ivec2(0, 0), ivec2(1, 1), ivec2(1, 0), -push.stripeRight, push.stripeLeft, -push.stripeBot, push.stripeTop);
        ...
        specularColor = getColorCorner(specularSampler, ivec2(0, 1), ivec2(0, 0), ivec2(1, 1), ivec2(1, 0), -push.stripeRight, push.stripeLeft, -push.stripeBot, push.stripeTop).b;
        ...
        //    |   |   |
        //   Q12 --- Q22
        outColor = getColorCorner(texSampler, ivec2(1, 2), ivec2(1, 1), ivec2(2, 2), ivec2(2, 1), 1 - push.stripeRight, 1 + push.stripeLeft, 1 - push.stripeBot, 1 + push.stripeTop);
        ...
        specularColor = getColorCorner(specularSampler, ivec2(1, 2), ivec2(1, 1), ivec2(2, 2), ivec2(2, 1), 1 - push.stripeRight, 1 + push.stripeLeft, 1 - push.stripeBot, 1 + push.stripeTop).b;
        ...
        //        |
        //        |
        outColor = getColorCorner(texSampler, ivec2(1, 1), ivec2(1, 0), ivec2(2, 1), ivec2(2, 0), 1 - push.stripeRight, 1 + push.stripeLeft, -push.stripeBot, push.stripeTop);
        ...
        specularColor = getColorCorner(specularSampler, ivec2(1, 1), ivec2(1, 0), ivec2(2, 1), ivec2(2, 0), 1 - push.stripeRight, 1 + push.stripeLeft, -push.stripeBot, push.stripeTop).b;
        ...
        //  |   |   |
        // Q02 --- Q12
        outColor = getColorCorner(texSampler, ivec2(0, 2), ivec2(0, 1), ivec2(1, 2), ivec2(1, 1), -push.stripeRight, push.stripeLeft, 1 - push.stripeBot, 1 + push.stripeTop);
        ...
        specularColor = getColorCorner(specularSampler, ivec2(0, 2), ivec2(0, 1), ivec2(1, 2), ivec2(1, 1), -push.stripeRight, push.stripeLeft, 1 - push.stripeBot, 1 + push.stripeTop).b;
    } else if (fract(fragTexCoord.x) < push.stripeLeft && fract(fragTexCoord.y) > push.stripeTop && fract(fragTexCoord.y) < 1 - push.stripeBot) {
        //      _  _
        //     |
        // Q01 - Q11 -
        //     |
        outColor = getColorSide(texSampler, ivec2(1, 1), ivec2(0, 1), fract(fragTexCoord.x), -push.stripeRight, push.stripeLeft);
        normalColor = getColorSide(normalSampler, ivec2(1, 1), ivec2(0, 1), fract(fragTexCoord.x), -push.stripeRight, push.stripeLeft).rgb;
        specularColor = getColorSide(specularSampler, ivec2(1, 1), ivec2(0, 1), fract(fragTexCoord.x), -push.stripeRight, push.stripeLeft).b;
        ...
        // - Q11 - Q21
        //       |
        outColor = getColorSide(texSampler, ivec2(2, 1), ivec2(1, 1), fract(fragTexCoord.x), 1 - push.stripeRight, 1 + push.stripeLeft);
        normalColor = getColorSide(normalSampler, ivec2(2, 1), ivec2(1, 1), fract(fragTexCoord.x), 1 - push.stripeRight, 1 + push.stripeLeft).rgb;
        specularColor = getColorSide(specularSampler, ivec2(2, 1), ivec2(1, 1), fract(fragTexCoord.x), 1 - push.stripeRight, 1 + push.stripeLeft).b;
    } else if (fract(fragTexCoord.y) < push.stripeTop && fract(fragTexCoord.x) > push.stripeLeft && fract(fragTexCoord.x) < 1 - push.stripeRight) {
        //   Q10
        //  - | -
        //   Q11
        //    |
        outColor = getColorSide(texSampler, ivec2(1, 1), ivec2(1, 0), fract(fragTexCoord.y), -push.stripeBot, push.stripeTop);
        normalColor = getColorSide(normalSampler, ivec2(1, 1), ivec2(1, 0), fract(fragTexCoord.y), -push.stripeBot, push.stripeTop).rgb;
        specularColor = getColorSide(specularSampler, ivec2(1, 1), ivec2(1, 0), fract(fragTexCoord.y), -push.stripeBot, push.stripeTop).b;
        ...
        //  - | -
        //   Q12 
        outColor = getColorSide(texSampler, ivec2(1, 2), ivec2(1, 1), fract(fragTexCoord.y), 1 - push.stripeBot, 1 + push.stripeTop);
